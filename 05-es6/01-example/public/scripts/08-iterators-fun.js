...
(function () {
    ...
    try {
        for (var _iterator5 = enumerable.where(function (item) {
            return item < 5;
    ...
    try {
        for (var _iterator6 = fibEnumerable.select(function (i) {
            return i * i;
        }).take(15)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
